  ...
  <div>
    ...
    <div class="calc_block">
      <div class="calc_leftBlock">
        ...
        <img class="calc_rightBlock_Image lg-none" src="https://gorizontbeton.ru/wp-content/uploads/2021/10/1_1.png" alt="" srcset="">
    ...
    <readme
      title="Онлайн калькулятор расчета объема бетона плиты"
